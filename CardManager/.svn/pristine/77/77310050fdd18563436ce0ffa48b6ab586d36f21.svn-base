...
CUBBYLoading.prototype={
  ...
  init:function(){
    if(this.div==null){
	    ...
	    document.getElementById("CUBBY_loadingDIV").style.display = "none";
    }
  },
  show:function(content){
	  if(content!=null){
         document.getElementById("CUBBY_loadingDIV").innerHTML = content;
	  }
...
CUBBYAjax.prototype = {
  ...
  initForm:function (formid) {
	if (CUBBYUtil.checkNotNull(formid)) {
		...
		var method = document.getElementById(formid).method;
