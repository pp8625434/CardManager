...
/**
 * AbstractAAppsysnetinTab generated by MyEclipse Persistence Tools
 */

public abstract class AbstractAAppsysnetinTab implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractAAppsysnetinTab() {
	}

	/** minimal constructor */
	public AbstractAAppsysnetinTab(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractAAppsysnetinTab(Integer id, Integer version, String sysname,
