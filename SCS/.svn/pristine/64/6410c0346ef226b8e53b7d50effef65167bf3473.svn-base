...
var CUBBYUtil = {
   ...
   addElementToBody:function(element){
     if(document.getElementById('body')!=null){document.getElementById('body').appendChild(element);}
   ...
   evalScripts:function(html){
	...
	//if(isopera|firefox) {return;} //  firefox and opera is auto load script,but ie cann't
