package com.manage.deviceiosys.model.original;
...
public abstract class AbstractDeviceIoSys extends BaseObject implements java.io.Serializable {
	...
	private Date recordordate;
	
	private String firstperson;
	private Integer firstpid;
	private Date firstsubdate;
	
	private String domainemailelse;
	private String sysnameelse;
	// Property accessors
	
	public String getDomainemailelse() {
		return domainemailelse;
	}
	public void setDomainemailelse(String domainemailelse) {
		this.domainemailelse = domainemailelse;
	}
	public String getSysnameelse() {
		return sysnameelse;
	}
	public void setSysnameelse(String sysnameelse) {
		this.sysnameelse = sysnameelse;
	}
	@Override
	...
	public String getInoutsysname() {
		return inoutsysname;
	}
	public void setInoutsysname(String inoutsysname) {
		this.inoutsysname = inoutsysname;
	}
	...
	public Date getRecordordate() {
		return recordordate;
	}
	public void setRecordordate(Date recordordate) {
		this.recordordate = recordordate;
	}
