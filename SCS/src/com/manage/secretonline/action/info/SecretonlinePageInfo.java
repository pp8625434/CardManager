package com.manage.secretonline.action.info;

import java.util.Date;

import com.base.framework.web.PageInfoView;

public class SecretonlinePageInfo extends PageInfoView{
	...
	protected  Integer  f_id;
 	...
 	protected  String  f_uname;
 	protected  String  f_uname_op;
	...
	public String getF_uname_op() {
		return f_uname_op;
	}
	public void setF_uname_op(String f_uname_op) {
		this.f_uname_op = f_uname_op;
	}
