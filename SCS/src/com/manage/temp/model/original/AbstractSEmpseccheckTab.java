...
/**
 * AbstractSEmpseccheckTab generated by MyEclipse Persistence Tools
 */

public abstract class AbstractSEmpseccheckTab implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractSEmpseccheckTab() {
	}

	/** minimal constructor */
	public AbstractSEmpseccheckTab(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractSEmpseccheckTab(Integer id, Integer version,
			String confidentiality, String education, String setpwd,
			String maintenance, String atinternet, String cymj,
			String classifiedsecret, String matnternet, String savepwdark,
			String perprocedure, String onlineregist, String handleaffairs,
			String smedia, String inforpublish, String timelyrepel,
			String ttbcsd, String rsd, String recordtz,
			String kconfidentiality, String phandleaffairs, String pconmedium,
			String pclassified, String ransforieinfor, String abroad,
			String cleartable, String otherinfor, String rectification,
			Date cdate, String cname, Integer cid) {
		this.id = id;
