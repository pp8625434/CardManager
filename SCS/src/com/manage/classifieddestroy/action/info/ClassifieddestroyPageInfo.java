package com.manage.classifieddestroy.action.info;

import com.base.framework.web.PageInfoView;

public class ClassifieddestroyPageInfo extends PageInfoView{
	...
	protected  String  f_dcode;
 	protected  String  f_dcode_op;
	...
	public String getF_dcode() {
		return f_dcode;
	}
	public void setF_dcode(String f_dcode) {
		this.f_dcode = f_dcode;
	}
	public String getF_dcode_op() {
		return f_dcode_op;
	}
	public void setF_dcode_op(String f_dcode_op) {
		this.f_dcode_op = f_dcode_op;
	}
