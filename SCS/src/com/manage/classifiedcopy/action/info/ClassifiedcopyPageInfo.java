package com.manage.classifiedcopy.action.info;

import java.util.Date;

import com.base.framework.web.PageInfoView;

public class ClassifiedcopyPageInfo extends PageInfoView{
	...
	protected  String  f_applyname;
 	protected  String  f_applyname_op;
	...
	public String getF_applyname() {
		return f_applyname;
	}
	public void setF_applyname(String f_applyname) {
		this.f_applyname = f_applyname;
	}
	public String getF_applyname_op() {
		return f_applyname_op;
	}
	public void setF_applyname_op(String f_applyname_op) {
		this.f_applyname_op = f_applyname_op;
	}
