...
public class SelectTagBuilder implements TagBuilder {
	...
	protected String buildSelect(SelectTagBean selectBean, TagInfoBean bean, Set values){
		...
		sb.append("<select");
		sb.append(" name=\"" + selectBean.getName() + "\" id=\"id_"+selectBean.getName()+"\" ");
		if(Utils.isNotNullOrEmpty(selectBean.getIsnull())){
			sb.append(" isnull=\""+selectBean.getIsnull()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getMes())){
			sb.append(" mes=\""+selectBean.getMes()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getDorder())){
			sb.append(" dorder=\""+selectBean.getDorder()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getCheckrepeat())){
			sb.append(" checkrepeat=\""+selectBean.getCheckrepeat()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getTablename())){
			sb.append(" tablename=\""+selectBean.getTablename()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getColumnname())){
			sb.append(" columnname=\""+selectBean.getColumnname()+"\" ");
		}
		if(Utils.isNotNullOrEmpty(selectBean.getRmes())){
			sb.append(" rmes=\""+selectBean.getRmes()+"\" ");
		}
